...
<p align="left">
  🌈 Habilidades: <strong>HTML5, CSS3, JavaScript, NextJS, Nuxt/Vue, Flutter, React</strong>
</p>

<p align="left">
  ⌨️ Habilidades: <strong>PHP, Docker, Typescript, NodeJS Laravel, CakePhP, Python, e Django.</strong>
</p>

<p align="left">
  💼 Ferramentas: <strong>VSCODE, Docker, Figma, Git, GitHub.</strong>
</p>
